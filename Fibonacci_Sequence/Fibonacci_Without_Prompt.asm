...
.data
prompt: .asciiz "How many Fibonacci numbers to generate? (2 <= x <= 10)"
size: .word  16            # size of "array" (agrees with array declaration)
fibs: .word  66 : 16       # "array" of words to contain fib values
...
#      li   $v0, 15 # Replace_this_dummy_with_the_correct_numeric_value???????           # specify Read Integer service
